...
class TaskFetcher
{
    ...
    public function __construct(Connection $connection, PaginatorInterface $paginator, EntityManagerInterface $repository)
    {
        $this->connection = $connection;
        $this->paginator = $paginator;
        $this->repository = $repository->getRepository(Task::class);
    }
